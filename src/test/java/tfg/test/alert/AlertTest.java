...
public class AlertTest {
	...
	public void findAlertTest(){
		...
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByRouteAndDate(route.getRouteId(), userProfile.getUserProfileId(), 0, 2, null, dateEnd);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByRouteAndDate(route.getRouteId(), userProfile.getUserProfileId(), 0, 2, dateStart, null);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByRouteAndDate(route.getRouteId(), userProfile.getUserProfileId(), 0, 2, null, null);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		...
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByDate(userProfile.getUserProfileId(), 0, 2, null, dateEnd);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByDate(userProfile.getUserProfileId(), 0, 2, dateStart, null);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
		alerts = alertDao.findAlertByDate(userProfile.getUserProfileId(), 0, 2, null, null);
		assertTrue(alerts.size()==2);
		assertEquals(alert, alerts.get(0));
		assertEquals(alert1, alerts.get(1));
